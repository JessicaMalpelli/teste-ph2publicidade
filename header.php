...
<head>
	...
	<meta name="author" content="Jessica Carolyne Malpelli">
	...
	<header>
		<div class="container-fluid">
			<nav class="navbar navbar-toggleable-md navbar-light">
				...
				<h1><a class="navbar-brand" href="index.php"><img src="img/logo.png" class="img-fluid"></a></h1>
				...
				<div class="collapse navbar-collapse" id="menu">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link" href="#" title="How It Work">How It Work</a>
						</li>
						<li class="nav-item">
